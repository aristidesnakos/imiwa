  ...
  try {
    ...
    const html = `
      ...
      <table cellpadding="8" style="border-collapse:collapse;width:100%;max-width:600px">
        ...
        ${website ? `<tr><td style="font-weight:bold">Website</td><td><a href="${website}">${website}</a></td></tr>` : ''}
        ${budget ? `<tr><td style="font-weight:bold">Budget</td><td>${budget}</td></tr>` : ''}
    ...
    await sendEmail({
      ...
      subject: `[MichiKanji] Advertising inquiry from ${name}`,
      html,
      replyTo: email,
    });
