...
export const metadata: Metadata = getSEOTags({
  title: 'N3 Kanji Practice Sheets Generator | Printable Japanese Worksheets',
  description: 'Generate printable kanji practice sheets for JLPT N3 characters. Download practice grids with stroke order diagrams for handwriting practice.',
  keywords: [
  ...
  openGraph: {
    title: 'N3 Kanji Practice Sheets Generator | Printable Japanese Worksheets',
    description: 'Generate high-quality printable practice sheets for JLPT N3 kanji. Perfect for learning proper stroke order and building muscle memory.',
    type: 'website',
  },
  canonicalUrlRelative: '/free-resources/kanji-sheets/n3-sheets',
});

export default function N3KanjiSheetsPage() {
  const jsonLd = {
    '@context': 'https://schema.org',
    '@type': 'WebApplication',
    name: 'N3 Kanji Practice Sheets Generator',
    description: 'Generate printable practice sheets for JLPT N3 kanji characters with stroke order diagrams',
    url: 'https://www.michikanji.com/free-resources/kanji-sheets/n3-sheets',
    ...
    keywords: 'kanji practice sheets, N3, JLPT, Japanese writing, stroke order'
  };
      ...
      <main id="main-content" tabIndex={-1} className="max-w-6xl mx-auto px-4 py-10 min-h-[60vh]">
        <div className="text-center mb-10">
          <h1 className="text-4xl font-bold text-gray-800 mb-3">
            N3 Kanji Practice Sheet Generator
          </h1>
        ...
        <div className="bg-gray-50 p-8 rounded-lg mb-8">
          <h2 className="text-xl font-semibold text-gray-700 mb-5">
            Select a Kanji Character ({N3_KANJI.length} available):
          </h2>
        ...
        <KanjiN5WorkbookCTA source="n3_kanji_sheets_page" />
