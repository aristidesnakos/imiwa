...
export default function N5KanjiSheetsPage() {
  const jsonLd = {
    ...
    url: 'https://www.michikanji.com/free-resources/kanji-sheets/n5-sheets',
      ...
      <main className="max-w-6xl mx-auto px-4 py-10 min-h-[60vh]">
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-gray-600 leading-relaxed max-w-2xl mx-auto">
            Generate printable practice sheets for JLPT N5 kanji with stroke order diagrams and practice grids
          </p>
        </div>

        <div className="bg-gray-50 p-8 rounded-lg mb-8">
          <h2 className="text-xl font-semibold text-gray-700 mb-5">
            Select a Kanji Character ({N5_KANJI.length} available):
          </h2>
