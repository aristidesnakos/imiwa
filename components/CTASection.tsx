      ...
      <div className="bg-gray-50 rounded-lg overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0">
          ...
          <div className="p-6 md:p-8 flex flex-col justify-center order-2 lg:order-1">
            <h3 className="font-semibold mb-4 text-lg md:text-xl text-gray-900">
              Ready to Start Your Language Learning Journey?
            </h3>
            <p className="mb-6 text-sm md:text-base text-gray-600 leading-relaxed">
              Practice Japanese with AI-powered feedback tailored to your learning goals. 
              Get instant corrections and personalized guidance to accelerate your progress.
            </p>
            <div>
              <a 
                href="https://llanai.com" 
          ...
          <div className="relative h-48 min-h-[200px] order-1 lg:order-2">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-transparent to-black/5 lg:hidden" />
          </div>
        </div>
      </div>
    </div>
